    ...
    protected void cmdExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(FI))
            {
                ...
                worksheet.Cells[StartRow, 2].Value = "ATM Name";
                worksheet.Cells[StartRow, 3].Value = "Address";                
                worksheet.Cells[StartRow, 4].Value = "Cash Loading Branch";
                ...
                //Adding Properties
                xlPackage.Workbook.Properties.Title = "Trust Bank ATM List";
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=" + "ATM_List.xlsx");
