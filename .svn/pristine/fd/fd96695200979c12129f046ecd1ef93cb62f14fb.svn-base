<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="POS.aspx.cs" Inherits="POS" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceBranchName" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString0 %>"
                            SelectCommand="SELECT DISTINCT FeedingBranch AS BranchID ,BranchName FROM    dbo.ATM AS A
                                        INNER JOIN dbo.ViewBranch AS B ON A.FeedingBranch = B.BranchID and A.Type = 'POS' ORDER BY BranchName">
                        </asp:SqlDataSource>
                    </td>
            ...
            <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AllowSorting="True"
                ...
                <EmptyDataTemplate>
                    <span class="style3">No Record Found </span>
                </EmptyDataTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString0 %>"
                SelectCommandType="StoredProcedure" SelectCommand="s_POS" ProviderName="<%$ ConnectionStrings:TblUserDBConnectionString0.ProviderName %>"
                ...
                <SelectParameters>
                    ...
                    <asp:Parameter Name="Type" DefaultValue="POS" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
            ...
            <asp:Panel ID="ModalPanel" runat="server" CssClass="Panel1 ui-corner-all">
                <div style="padding: 5px">
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" BackColor="White" BorderColor="#DEDFDE"
                        ...
                        <Fields>
                            <asp:BoundField DataField="ID" HeaderText="POS ID" SortExpression="ID" ReadOnly="true"
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString0 %>"
                InsertCommand="s_POS_Insert" InsertCommandType="StoredProcedure" ProviderName="<%$ ConnectionStrings:TblUserDBConnectionString0.ProviderName %>"
                SelectCommand="SELECT * FROM v_ATM WHERE (ID = @ID AND Type='POS')" UpdateCommand="s_POS_Update"
                ...
                <UpdateParameters>
                    ...
                    <asp:Parameter Name="Type" DefaultValue="POS" />                    
            ...
            <asp:SqlDataSource ID="SqlDataSourceVendor" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString0 %>"
                SelectCommand="SELECT [ID], [VendorName] FROM [Vendors] WHERE TYPEID = 1 ORDER BY [VendorName]">
            </asp:SqlDataSource>
            <br />
            <br />
        </ContentTemplate>
