...
public partial class TrustYouniverse : System.Web.UI.Page
{
    ...
    protected void cmdExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(FI))
            {
                ...
                //Adding Properties
                xlPackage.Workbook.Properties.Title = "Trust Youniverse";
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=" + "TrustYouniverse.xlsx");
    ...
    protected void DetailsView1_DataBound(object sender, EventArgs e)
    {
        try
        {
            if (TrustControl1.isRole("ADMIN") 
                || TrustControl1.isRole("EDITOR") 
                || TrustControl1.isRole("TRUSTYOUNIVERSE"))
            {
