<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="ATM.aspx.cs" Inherits="ATM" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphTitle" runat="Server">
    <table>
        <tr>
            ...
            <td>
                Trust Bank ATMs (Automated Teller Machine)
            </td>
        </tr>
    </table>
</asp:Content>
        ...
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceBranchName" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString0 %>"
                            ...
                            INNER JOIN dbo.ViewBranch AS B ON A.FeedingBranch = B.BranchID and A.Type = 'ATM'
                            ORDER BY BranchName"></asp:SqlDataSource>
                    </td>
            ...
            <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ITCL_ATM_ID" HeaderText="ITCL ID" ReadOnly="true" ItemStyle-HorizontalAlign="Center"
                        HeaderStyle-Wrap="false" SortExpression="ITCL_ATM_ID">
                        <HeaderStyle Wrap="False" />
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="ATM Name" SortExpression="Name">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Cash Loading Branch" SortExpression="FeedingBranchName">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Map">
                        <ItemTemplate>
                            <a href='GoogleMap.aspx?atm=<%# Eval("ID") %>' target="_blank" title="View in Google Map">
                                <%# Eval("Latitude", "<img src='Images/marker-atm.png' width='24' height='24' />")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                <EmptyDataTemplate>
                    <span class="style3">No Match Found </span>
                </EmptyDataTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString0 %>"
                ...
                <SelectParameters>
                    ...
                    <asp:Parameter Name="Type" DefaultValue="ATM" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
            ...
            <asp:Panel ID="ModalPanel" runat="server" CssClass="Panel1 ui-corner-all">
                <div style="padding: 5px">
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" BackColor="White" BorderColor="#DEDFDE"
                        ...
                        <Fields>
                            <asp:BoundField DataField="ID" HeaderText="ATM ID" SortExpression="ID" ReadOnly="true"
                                ItemStyle-Font-Bold="true" ItemStyle-Font-Size="Large">
                                <ItemStyle Font-Bold="True" Font-Size="Large" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ITCL_ATM_ID" HeaderText="ITCL ATM ID" SortExpression="ITCL_ATM_ID"
                                ControlStyle-Width="200px" ReadOnly="true"></asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Cash Loading Branch" SortExpression="FeedingBranch">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Minimum ATM Balance" SortExpression="MinimumAtmBalance">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtMinimumAtmBalance" Font-Names="Arial" runat="server" Text='<%# Bind("MinimumAtmBalance","{0:N2}") %>'
                                        Width="100px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator222" runat="server" ControlToValidate="txtMinimumAtmBalance"
                                        ErrorMessage="*"></asp:RequiredFieldValidator>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="txtMinimumAtmBalance" Font-Names="Arial" runat="server" Text='<%# Bind("MinimumAtmBalance","{0:N2}") %>'
                                ...
                                <ItemTemplate>
                                    <%# Eval("MinimumAtmBalance","{0:N2}").ToString().Replace("\n", "<br>")%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Maximum Notes Per Casset" SortExpression="MaximumNotesPerCasset">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtMaximumNotesPerCasset" Font-Names="Arial" runat="server" Text='<%# Bind("MaximumNotesPerCasset","{0:N0}") %>'
                                        Width="100px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator224552" runat="server" ControlToValidate="txtMaximumNotesPerCasset"
                                        ErrorMessage="*"></asp:RequiredFieldValidator>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="txtMaximumNotesPerCasset" Font-Names="Arial" runat="server" Text='<%# Bind("MaximumNotesPerCasset","{0:N0}") %>'
                                ...
                                <ItemTemplate>
                                    <%# Eval("MaximumNotesPerCasset", "{0:N0}").ToString().Replace("\n", "<br>")%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Links" SortExpression="LinkVendor1">
                                <EditItemTemplate>
                                    Vendor 1:
                                ...
                                <ItemTemplate>
                                    <%# Eval("LinkVendor1Name", "<div>Vendor 1: {0}</div>")%>
                                    <%# Eval("LinkVendor2Name", "<div>Vendor 2: {0}</div>")%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField ShowHeader="False" ControlStyle-Width="100px">
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chkIsActive" Text="Active" Checked='<%# Eval("IsActive") %>'
                                        Enabled="false" />
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString0 %>"
                ...
                SelectCommand="SELECT * FROM v_ATM WHERE (ID = @ID AND Type='ATM')" UpdateCommand="sp_ATM_Update"
                ...
                <UpdateParameters>
                    ...
                    <asp:Parameter Name="Type" DefaultValue="ATM" />
                    <asp:Parameter Name="Latitude" />
                    <asp:Parameter Name="Longitude" />
                    <asp:Parameter Name="MaximumNotesPerCasset" Type="Decimal" />
